...
public class TitledPanel extends JPanel {
  ...
  public TitledPanel(String title) {
    ...
    this.setBorder(BorderFactory.createTitledBorder(etchedBorder, title,
        TitledBorder.LEFT, TitledBorder.TOP, GuiStatics.FONT_NORMAL, GuiStatics.COLOR_WHITE));
  }  
